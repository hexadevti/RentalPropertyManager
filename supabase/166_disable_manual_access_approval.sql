-- Access approval is no longer required.
-- New self-signup users should be created as approved immediately, and any
-- existing pending profiles should be promoted unless they were explicitly
-- rejected.
