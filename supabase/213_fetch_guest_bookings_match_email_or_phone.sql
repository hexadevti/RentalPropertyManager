-- Migration 213: improve my bookings lookup by matching guest email or phone.

-- Backward compatibility: keep 2-arg signature and add 3-arg version used by portal UI.
...
-- Compatibility wrapper (legacy calls with only email)
create or replace function public.fetch_guest_bookings(
  p_tenant_id uuid,
  p_guest_email text
)
