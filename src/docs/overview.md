...
| **Contratos** | Gestão de locações mensais e temporadas |
...
| **Templates** | Modelos de contrato para geração de PDF |
| **IA Assistente** | Chat inteligente para consultas sobre os dados |
...
3. **Crie contratos** — vincule hóspede, propriedade, datas e valores
...
- **Admin** — acesso completo ao tenant (todos os módulos e dados)
...
> O assistente de IA pode responder perguntas sobre qualquer módulo em linguagem natural.
